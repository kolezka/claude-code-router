...
contextBridge.exposeInMainWorld("ccr", {
  ...
  getLocalAgentProviderCandidates: (request?: LocalAgentProviderScanRequest) => invoke(IPC_CHANNELS.appGetLocalAgentProviderCandidates, request) as Promise<LocalAgentProviderCandidate[]>,
