...
ipcMain.handle(IPC_CHANNELS.appGetLocalAgentProviderCandidates, (_event, request?: LocalAgentProviderScanRequest) => getLocalAgentProviderCandidates(request));
