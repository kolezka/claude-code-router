...
export const appCopy: Record<ResolvedLanguage, AppCopy> = {
  en: {
    ...
    text: {
      ...
      "CCR left its entries in {file}. Remove them manually or re-enable this profile.": "CCR left its entries in {file}. Remove them manually or re-enable this profile.",
  ...
  zh: {
    ...
    text: {
      ...
      "CCR left its entries in {file}. Remove them manually or re-enable this profile.": "CCR 已将其配置项保留在 {file} 中。请手动移除这些配置项，或重新启用此配置档案。",
